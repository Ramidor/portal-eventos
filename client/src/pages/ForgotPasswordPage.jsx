    ...
    <AuthLayout
      headline={
        <>
          ...
          tu
          <br />
          <span className="text-orange-400">acceso.</span>
        </>
      }
        ...
        {sent ? (
          <div className="bg-green-950/30 border border-green-800 rounded-xl p-6 text-center">
            ...
            <p className="text-zinc-400 text-sm">
              Si el email está registrado y verificado, recibirás un enlace en
              los próximos minutos.
            </p>
            <Link
              to="/login"
              className="inline-block mt-6 text-orange-400 hover:text-orange-300 font-mono text-xs transition-colors"
            >
