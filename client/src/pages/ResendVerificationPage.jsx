...
export default function ResendVerificationPage() {
  ...
  // 2. Usamos ese valor como estado inicial
      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <div className="flex justify-center mb-4">
            <RefreshCw size={40} className="text-orange-400" />
          </div>
          <h1 className="text-2xl font-serif text-zinc-100 mb-2">
            Reenviar código
          </h1>
          <p className="text-zinc-500 text-sm">
            Introduce tu email y te enviaremos un nuevo código numérico de 6
            dígitos.
          </p>
        </div>
